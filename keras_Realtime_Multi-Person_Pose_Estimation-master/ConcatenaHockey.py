...
def salva_csv(dict,value):
    file_exists = os.path.isfile('dataset_hockey.csv')
    with open('dataset_hockey.csv', mode='a', newline='') as csv_file:
...
def salva_csv_dist(list1,list2, value):
    file_exists = os.path.isfile('dataset_dist_hockey.csv')
    with open('dataset_dist_hockey.csv', mode='a', newline='') as csv_file:
